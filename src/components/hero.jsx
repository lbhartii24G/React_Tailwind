...
const Hero = () => {
    return (
        <div className="hero_wrapper container_wrapper mt-10 mx-auto ">
            <span className="text-xs tracking-[.23em] text-[#ff8142]" >NEXT-GEN EXPERIENCE STUDIOs</span>
  ...
  normal-case">high-impact</span> design.</h1>
            ...
            <h6 className="text-xs tracking-[.23em] text-[#ffffffbf] uppercase text-left mb-10 mt-10">Trusted By</h6> 
